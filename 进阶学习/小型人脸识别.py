...
img = cv2.imread('q.jpg',1)

# 导入人脸级联分类器引擎，'.xml'文件里包含训练出来的人脸特征
face_engine = cv2.CascadeClassifier("C:\\Users\\Lenovo\\anaconda3\\envs\\tensorflow\\Library\\etc\\haarcascades\\haarcascade_frontalface_default.xml")
